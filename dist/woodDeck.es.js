...
function cr() {
  return Se || (Se = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function Ie(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === T || e === W || Ae || e === I || e === O || e === p || Fe || e === $ || xe || ke || De || typeof e == "object" && e !== null && (e.$$typeof === R || e.$$typeof === b || e.$$typeof === j || e.$$typeof === E || e.$$typeof === c || // This needs to include all possible module reference object
    ...
    function Re(e, r) {
      {
        ...
        Ee[t] = !0;
        var n = "";
        e && e._owner && e._owner !== G.current && (n = " It was passed a child from " + y(e._owner.type) + "."), C(e), l('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', t, n), C(null);
      }
    }
    function _e(e, r) {
      {
    ...
    function nr(e) {
      {
        for (var r = Object.keys(e.props), t = 0; t < r.length; t++) {
          var n = r[t];
          if (n !== "children" && n !== "key") {
            C(e), l("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", n), C(null);
            break;
          }
        }
...
var vr = Z.exports;
const gr = () => /* @__PURE__ */ vr.jsx("button", { children: "Click me" });
export {
  gr as Button,
  pr as sum
};
